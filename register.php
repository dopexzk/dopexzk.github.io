...
<body class="text-center">
    <?php if(!isset($_SESSION["user"])){ ?>
        ...
        <p>————————或————————</p>
        <input type="password" class="form-control" name="pw" placeholder="帳號" class="form-control col-xl-6" id="pwd">
        <input type="password" class="form-control" name="pw" placeholder="密碼" class="form-control col-xl-6" id="pwd">
        <input type="password" class="form-control" name="pw" placeholder="手機" class="form-control col-xl-6" id="pwd">
        <input type="password" class="form-control" name="pw" placeholder="電子郵件" class="form-control col-xl-6" id="pwd">
        <div class="checkbox mb-3">
        <h10>已經有帳號嗎? <a href="login.php" target="_blank">登入</a></h10>
        <br>
        <input type="checkbox" value="remember-me"> 註冊即表示你同意我們的 服務條款 、 資料政策 和 Cookie 政策 。
        </label>
        </div>
